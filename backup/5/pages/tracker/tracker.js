$(document).ready(function(){
	...
	function task_select_create ( input, callback ) {
		...
		if ( dom_project_select.value === '' || dom_project_select.value === 'new_project' ) {
			
			display_error( "Select a project first." );
    ...
    $('#dom_button_project_create').click( dom_button_project_create_click );
    $('#dom_button_project_cancel').click( dom_button_project_cancel_click );
    $('#dom_button_task_create').click( dom_button_task_create_click );
