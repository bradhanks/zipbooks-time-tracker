	...
	class Zipbooks {
		...
		public static function send_invoice ( $data ) {
			Zipbooks::post(
				...
				'send_to='.$data['customer_email'].
				'&subject='.$data['user_first_name'].' Invoice '.$data['number'].
				'&message='."You've got a new invoice from ".$data['user_first_name']." ".$data['user_last_name']." for ".$data['total'].". View your invoice here: \n ::link:: \n\n Thanks, \n ".$data['user_first_name'].
				'&attach_pdf='.'1'
			);
		}
